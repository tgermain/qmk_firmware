 ...
 */
  ...
  [GAME]=LAYOUT_6x6(
    ...
    US_K,    KC_LCTL, US_Z,     US_X,     US_C,     US_V,           US_B,     US_N,     US_M,     _______,  _______,  _______,
                      _______,  _______,                                                _______,  _______,
                                  KC_SPC,   US_T,                     _______, _______,
                                    US_B,   US_G,                   _______, _______,
 ...
 */
  [ACCENT]=LAYOUT_6x6(
    ...
    _______, _______, _______, _______, _______, _______,         _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______,         _______, _______, _______, _______, _______, _______,
    _______, _______, US_EACU, _______, _______, _______,         _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______,         _______, _______, _______, _______, _______, _______,
                      _______, _______,                                             _______, _______,
                                  _______, _______,             _______, _______,
                                    _______, _______,        _______, _______,
