 ...
 *                                   `---------------'      `---------------'     generated by [keymapviz] */
  [SYMB]=LAYOUT_6x6(
    ...
    _______, FR_HASH, FR_DLR,   FR_LPRN,  FR_RPRN, FR_GRV,          FR_MINS,  FR_4,   FR_5,     FR_6,    FR_PLUS, FR_BSLS,
    KC_LSFT, FR_PERC, FR_CIRC,  FR_LBRC,  FR_RBRC, FR_TILD,         FR_EQL,   FR_1,   FR_2,     FR_3,    FR_SLSH, TG(GAME),
